...
public class EntityUtils {
    ...
    public static CustomerEntity copy(CustomerEntity original, String notes) {
        ...
        entity.setUsername(original.getUsername());
        entity.setFull_name(original.getFull_name());
        ...
        entity.setPrimary_image(original.getPrimary_image());
    ...
    public static OrderEntity copy(OrderEntity original, String status) {
        ...
        entity.setSubTotal(original.getSubTotal());
        entity.setItems(original.getItems());
        entity.setGuest(original.isGuest());
        ...
        entity.setDeliveryDate(original.getDeliveryDate());
        entity.setAffiliate(original.isAffiliate());
        entity.setAffiliate(original.getAffiliate());
        ...
        entity.setBillingName(original.getBillingName());
        entity.setBillingPhone(original.getBillingPhone());
        entity.setBillingEmail(original.getBillingEmail());
        entity.setOrderNote(original.getOrderNote());
