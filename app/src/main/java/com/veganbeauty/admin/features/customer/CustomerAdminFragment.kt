...
class CustomerAdminFragment : RootieAdminFragment() {

    private var _binding: CustomerAdminMainFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = CustomerAdminMainFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecyclerView() {
        adapter = CustomerAdapter(
            ...
            onDetailClick = { customer ->
                val detailFragment = CustomerDetailFragment.newInstance(customer.id, fromStaff = false)
            ...
            onNoteClick = { customer ->
                ...
                bottomSheet.onNoteSaved = {
                    loadData() // Refresh list to show updated notes count if any
                }
    ...
    private fun setupListeners() {
        ...
        binding.btnBack.setOnClickListener {
            // Navigate back to home or select home tab
            val mainActivity = activity as? MainActivity
            mainActivity?.let {
        ...
        binding.btnCreateCampaign.setOnClickListener {
            (activity as? MainActivity)?.loadFragment(CustomerCreateCampaignFragment())
        }
