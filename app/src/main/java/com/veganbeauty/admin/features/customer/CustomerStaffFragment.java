...
public class CustomerStaffFragment extends RootieAdminFragment {

    private CustomerStaffMainFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = CustomerStaffMainFragmentBinding.inflate(inflater, container, false);
    ...
    private void setupRecyclerView() {
        adapter = new CustomerAdapter(
            new ArrayList<>(),
            customer -> {
                CustomerDetailFragment detailFragment = CustomerDetailFragment.newInstance(customer.getId(), true);
                MainActivity mainActivity = (MainActivity) getActivity();
                if (mainActivity != null) {
            ...
            customer -> {
                ...
                bottomSheet.setOnNoteSavedListener(() -> loadData());
